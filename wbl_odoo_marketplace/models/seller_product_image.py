...
class SellerProductImage(models.Model):
    _name = 'seller.product.image'
    _description = "Seller Product Image"
    ...
    seller_product_id = fields.Many2one('mp.seller.product', "Seller Product", index=True, ondelete='cascade')
    ...
    def create(self, vals_list):
        ...
        return super().create(normal_vals) + super(SellerProductImage, context_without_template).create(variant_vals_list)
